...
💡 Tip: The more specific your description, the better we can meet your needs`,
  ...
  'workspace.billing.seats.confirmContent':
    'Seats will change from {{previousSeats}} to {{newSeats}}. Stripe will charge or refund a prorated amount for the remainder of this billing cycle.',
  ...
  'workspace.billingPage.billing.activeHint':
    'Cancel anytime — you keep access until the end of the cycle.',
  ...
  'workspace.billingPage.billing.scheduledHint':
    'Subscription will end at the close of the current billing cycle.',
  ...
  'workspace.billingPage.credits.topUp.maxAmountError':
    'Purchase amount cannot exceed ${{max}} per transaction.',
  ...
  'workspace.billingPage.credits.topUp.subtitle':
  ...
  'workspace.billingPage.credits.autoTopUp.pausedReason.payment_failed':
    'A recent charge failed. Update the payment method and re-enable.',
  ...
  'workspace.billingPage.credits.autoTopUp.subtitle':
    'Keep credits topped up automatically so the team is never blocked.',
  ...
  'workspace.billingPage.plans.enterprise.features.customIntegration':
  ...
  'workspace.billingPage.plans.enterprise.tagline':
  ...
  'workspace.billingPage.plans.creditsHint':
    'Shared monthly pool · every seat draws from the same balance',
  ...
  'workspace.general.copyAgentGroups.modal.copyOptions.knowledgeBase.reason':
    'Not supported yet. Reconnect them in the target workspace or personal account after copying.',
  'workspace.general.copyAgentGroups.modal.copyOptions.knowledgeBase.title':
  ...
  'workspace.general.name.description':
  ...
  'workspace.general.url.confirm.content':
    'Existing links to "/{{old}}" will stop working immediately. Anyone who shared a link to this workspace will need a new one. This change cannot be undone.',
  ...
  'workspace.slugBrandApply.modalCreateTip':
    'You can also create your workspace with another URL now and email us at {{email}} from your organization email to request this one later.',
  'workspace.slugBrandApply.modalDesc':
    'This URL is reserved for a protected brand. If you own this brand, apply from your organization email and we’ll review your request shortly.',
  ...
  'workspace.member.removeConfirm.content':
  ...
  'workspace.invitePage.alreadyAcceptedSubtitle':
    'This invitation has already been used. You should already be a member of the workspace.',
  ...
  'workspace.invitePage.differentEmailNotice':
    'You are signed in as {{currentEmail}}, but this invitation was sent to {{inviteEmail}}.',
  ...
  'workspace.invitePage.revokedSubtitle':
  ...
  'workspace.wizard.step1.slug.invalidLength':
  ...
  'workspace.wizard.step3.subtitle':
  ...
  'workspace.wizard.closeConfirm.content':
    'Your workspace details have not been saved. Closing now will discard them.',
  ...
  'workspace.onboarding.step1.guide.name.desc':
    'A name your teammates instantly recognize keeps collaboration smooth.',
  'workspace.onboarding.step1.guide.knowYou.title': 'Get to Know the Team',
  'workspace.onboarding.step1.guide.knowYou.desc':
    "Share what you're working on — more context means better help.",
  ...
  'workspace.onboarding.step2.subtitle':
    "Pick one or more — we'll suggest starter agents to match. You can change this later.",
